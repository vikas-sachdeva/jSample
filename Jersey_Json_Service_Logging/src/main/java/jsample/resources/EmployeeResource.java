...
/*
 * Specify path of java log file through VM arguments -
 * 
 * -Djava.util.logging.config.file="F:\mine\eclipse\workspaces\jsample\Jersey_Json_Service_Logging\config\log_config.properties"
 */
